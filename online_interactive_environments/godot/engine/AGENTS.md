...
> 通用工作规范沿用仓库根 [../../../AGENTS.md](../../../AGENTS.md)；
...
- **Python 通信、进程、SB3 适配与训练入口**放在父目录 `online_interactive_environments/godot/`。
- CraftGround 环境位于同级 `online_interactive_environments/craftground/`，不与 Godot 实现互相导入。
