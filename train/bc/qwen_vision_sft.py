"""Qwen3.6 视觉 SFT 入口：在 TAP 动作数据上微调 Qwen3.6 主干。
...
用法::
    ...
    python -m train.bc.qwen_vision_sft --model unsloth/Qwen3.6-35B-A3B \
        --dataset-dir runs/datasets/tao-10xx --output-dir runs/trains/sft-qwen
...
def main() -> None:
    ...
    parser = build_argument_parser(
        description="在 TAP 动作数据上微调 Qwen3.6 视觉主干",
