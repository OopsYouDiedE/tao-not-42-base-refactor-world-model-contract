...
from dataset.organization.sft_protocol import normalize_question, training_reason
...
def _approved_review(record: dict[str, Any]) -> bool:
    ...
    scores_are_valid = scores is None or (
...
def main() -> None:
    ...
    result = pack_approved_questions(
        ...
        arguments.output,
        arguments.ai_reviews,
        arguments.human_reviews,
