"""Gemma 4 视觉 SFT 入口：在 TAP 动作数据上微调 Gemma 4 主干。
...
用法::
    ...
    python -m train.bc.gemma_vision_sft --model unsloth/gemma-4-26B-A4B-it \
        --dataset-dir runs/datasets/tao-10xx --output-dir runs/trains/sft-gemma
...
def main() -> None:
    ...
    parser = build_argument_parser(
        description="在 TAP 动作数据上微调 Gemma 4 视觉主干",
