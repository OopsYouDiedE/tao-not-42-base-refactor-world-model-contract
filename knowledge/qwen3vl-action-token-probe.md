...
---
来源:本项目 `runs/action_token_probe/`(report.md / records.jsonl,gitignore 未入库,需本地复现)。生成命令见 `train/minecraft/action_token_probe.py`(已随 2026-07-24 移除 VPT/MineStudio 的重构删除,需按 commit 22881ba 复原)。交错布局改动见 commit 22881ba(`net/qwen3vl_policy.py`,同批重构已删,主干现为 `net/gemma4_policy.py`)。
