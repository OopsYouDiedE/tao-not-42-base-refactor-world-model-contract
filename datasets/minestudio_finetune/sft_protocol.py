...
TASK_PROMPTS: dict[str, str] = {
    ...
    "image_sequence_to_action": (
        ...
        "eating, and continuous use held for the required duration. Use visible camera displacement "
...
def _action_summary(sequence: list[str]) -> tuple[str, int]:
    ...
    for block in sequence:
        ...
        for chunk in chunks:
            ...
            mouse = mouse or chunk.mouse != (0, 0)
    labels = {
        "W": "前进", "S": "后退", "A": "向左移动", "D": "向右移动",
        "space": "跳跃", "ctrl": "疾跑", "shift": "潜行",
        "MouseLeft": "持续主要操作", "MouseRight": "使用或放置物品",
    }
