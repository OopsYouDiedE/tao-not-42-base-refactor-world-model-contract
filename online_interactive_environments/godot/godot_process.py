...
from .shared_memory_environment import GODOT_EXE, IS_WINDOWS, PROJECT_DIR, TRAIN_SCENE
...
def launch_godot(
    ...
    return subprocess.Popen(
        [godot_exe, "--path", project_dir, scene], stdout=stdout, stderr=subprocess.STDOUT, env=env
    )
