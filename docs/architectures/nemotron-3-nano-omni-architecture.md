...
**定位(本项目)**: 双系统慢塔 VLM worker 的生产候选；现行接口见 `knowledge/README.md`。
**实测**: 单卡 RTX 5090 原生加载跑通,见 knowledge/README.md;
零样本像素直控失败,见 knowledge/README.md
...
> **2026-07-09 张量级核实（见 knowledge/README.md §3）**：此处描述正确，但要补一句关键的——
